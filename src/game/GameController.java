...
import game.BotController.MinimaxMove;
...
//		MinimaxMove minimaxRoot= new MinimaxMove(board, playerAnimals, robotAnimals);
		...
		System.out.println("tong so nut da duyet= "+ minimaxRoot.count);
	...
	public static void initBoard1() {
		...
		board[5][1] = new Tiger(2, new Coordinate(5, 1),800);
		...
		board[3][2] = new Cheetah(2, new Coordinate(3, 2),500);
		...
		board[3][4] = new Lion(1, new Coordinate(3, 4),-900);
		...
		board[2][6] = new Lion(2, new Coordinate(2, 6), 900);
		...
		board[3][7] = new Cheetah(1, new Coordinate(3, 7),-500);
		board[4][7] = new Dog(1, new Coordinate(4, 7),-400);
	...
	public Node getNodeByRowColumnIndex(final int row, final int column) {
		...
		for (Node node : childrens) {
			if (boardGame.getRowIndex(node) == row && boardGame.getColumnIndex(node) == column) {
				result = node;
				break;
			}
		}
